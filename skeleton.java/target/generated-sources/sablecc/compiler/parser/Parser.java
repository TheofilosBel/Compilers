...
public class Parser
{
    ...
    ArrayList new1() /* reduce AFuncDefFuncDef */
    {
        ...
        pfuncdefNode1 = new AFuncDef(tidNode2, pfparlistNode3, ptypeNode4, plocaldeflistNode5, pstmtNode6);
        }
    ...
    @SuppressWarnings("unchecked")
    ArrayList new13() /* reduce AAfpardeffpardef1FparDef */
    {
        @SuppressWarnings("hiding") ArrayList nodeList = new ArrayList();
    ...
    @SuppressWarnings("unchecked")
    ArrayList new14() /* reduce AAfpardeffpardef2FparDef */
    {
        @SuppressWarnings("hiding") ArrayList nodeList = new ArrayList();
