...
public final class AFirstEmptyArrayDec extends PArrayDec
{
    private final LinkedList<TIntConst> _intConst_ = new LinkedList<TIntConst>();

    public AFirstEmptyArrayDec()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFirstEmptyArrayDec(
            cloneList(this._intConst_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFirstEmptyArrayDec(this);
    }
