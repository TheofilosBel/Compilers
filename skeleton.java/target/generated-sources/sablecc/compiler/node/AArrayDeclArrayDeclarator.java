...
public final class AArrayDeclArrayDeclarator extends PArrayDeclarator
{
    ...
    public AArrayDeclArrayDeclarator(
        ...
        @SuppressWarnings("hiding") List<PArrayDeclaratorTail> _arrayDeclaratorTail_)
    {
        // Constructor
    ...
    public void setArrayDeclaratorTail(List<PArrayDeclaratorTail> list)
    {
        this._arrayDeclaratorTail_.clear();
        this._arrayDeclaratorTail_.addAll(list);
        for(PArrayDeclaratorTail e : list)
        {
            if(e.parent() != null)
            {
