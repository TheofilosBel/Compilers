...
public final class ASingleFparFparList extends PFparList
{
    private PFparDef _fparDef_;

    public ASingleFparFparList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASingleFparFparList(
            cloneNode(this._fparDef_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseASingleFparFparList(this);
    }
