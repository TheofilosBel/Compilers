...
public interface Analysis extends Switch
{
    ...
    void caseAFirstEmptyArrayDec(AFirstEmptyArrayDec node);
    void caseAEmptyArrayDec(AEmptyArrayDec node);
    ...
    void caseAGteqCond(AGteqCond node);
    void caseALteqCond(ALteqCond node);
    ...
    void caseTErroneousId(TErroneousId node);
