...
public class DepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inAFirstEmptyArrayDec(AFirstEmptyArrayDec node)
    {
        defaultIn(node);
    }

    public void outAFirstEmptyArrayDec(AFirstEmptyArrayDec node)
    {
        defaultOut(node);
    }
    ...
    public void caseAFirstEmptyArrayDec(AFirstEmptyArrayDec node)
    {
        ...
        outAFirstEmptyArrayDec(node);
    }

    public void inAEmptyArrayDec(AEmptyArrayDec node)
    {
        defaultIn(node);
    }

    public void outAEmptyArrayDec(AEmptyArrayDec node)
    {
        defaultOut(node);
    }
    ...
    {
        inAEmptyArrayDec(node);
        outAEmptyArrayDec(node);
    }
    ...
    public void inAGteqCond(AGteqCond node)
    {
        defaultIn(node);
    }
    ...
    public void inALteqCond(ALteqCond node)
    {
        defaultIn(node);
    }
