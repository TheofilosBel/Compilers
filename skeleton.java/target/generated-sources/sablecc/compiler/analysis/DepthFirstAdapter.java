...
public class DepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void caseAByrefFparDef(AByrefFparDef node)
    {
        ...
        {
            List<PVariable> copy = new ArrayList<PVariable>(node.getVarList());
    ...
    public void inAByvallFparDef(AByvallFparDef node)
    {
        defaultIn(node);
    }

    public void outAByvallFparDef(AByvallFparDef node)
    {
        defaultOut(node);
    }
    ...
    public void inANoneDataType(ANoneDataType node)
    {
        defaultIn(node);
    }

    public void outANoneDataType(ANoneDataType node)
    {
        defaultOut(node);
    }
    ...
    {
        inANoneDataType(node);
        outANoneDataType(node);
    }
